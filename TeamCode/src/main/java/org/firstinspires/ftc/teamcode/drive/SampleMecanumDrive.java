...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(3.3, 0, 0);
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        /* Not used in three-wheel odometry
    ...
    public double getRawExternalHeading() {
        // return imu.getAngularOrientation().firstAngle; not used in three-wheel odometry
        return 0;
    }
}
