...
public class TeleopFieldCentric extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            Pose2d poseEstimate = roboto.drive.getPoseEstimate();

            Vector2d controllerTranslation = new Vector2d(
                    -Math.pow(controller1.getAnalogValue("left_stick_y"), 3),
                    -Math.pow(controller1.getAnalogValue("left_stick_x"), 3)).rotated(-poseEstimate.getHeading());
            roboto.setVel(new Pose2d(
                    controllerTranslation.getX(),
                    controllerTranslation.getY(),
