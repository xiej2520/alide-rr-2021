...
public class Auto2 extends LinearOpMode {
    ...
    public static int mainY = -48;
    public static int rightY = -60;

    public static int startY = mainY;
    public static int dodgeWallY = mainY;
    public static int shoot1Y = mainY;
    public static int suck1Y = mainY;
    public static int suck2Y = mainY;
    public static int shoot2Y = mainY;
    public static int parkY = mainY;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory startToSwerve = drive.trajectoryBuilder(startP) // A, B, C
                .splineToConstantHeading(swerveV, 0)
                .build();
        ...
        Trajectory dodgeWallToShoot1 = drive.trajectoryBuilder(zoneAToDodgeWall.end()) // A
        ...
        Trajectory swerveToZoneB = drive.trajectoryBuilder(startToSwerve.end()) // B
                .splineToConstantHeading(zoneBV, 0)
                .build();
        ...
        if (rings == 0) { // Zone A
            ...
            drive.followTrajectory(zoneAToDodgeWall);
